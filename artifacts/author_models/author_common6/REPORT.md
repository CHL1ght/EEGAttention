...
- common channels: `F7, F3, P7, O1, O2, P8`
- common6 EDF adapter: `F7-Pz→F7, F3-Pz→F3, T5-Pz→P7, O1-Pz→O1, O2-Pz→O2, T6-Pz→P8`; `AF4` is intentionally excluded.
- recordings: 23；blocks: 46；windows: 13754
- raw feature dimension: 60；PCA: 19 components
- GroupKFold accuracy: 64.69% ± 4.29%
- GroupKFold balanced accuracy: 64.69% ± 4.29% (5 valid folds)
- LOCKED_TEST 未参与任何 fit；跨来源结果仅作 exploratory/channel-aligned comparison，author MAT reference 仍未知。
