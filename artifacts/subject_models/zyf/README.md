...
状态：`historical baseline`。它不是未来的 `zyf-new personal`，不得用 New Paradigm v1 名义覆盖。
...
检验同一个人的历史数据是否足够应付新的录制条件。

## 输入从哪里来

zyf：12个EDF、7个session group，4483个窗口。 没有使用：lyc、zqd、未知身份、LOCKED_TEST、LAB_FEEDBACK。
...
已完成；LOCKED_TEST lyc Acc45.79% / Bal56.45%；zyf41.35% /52.14%。

## 我什么时候需要看这个目录

zyf现场与旧pooled/mixed对照。
