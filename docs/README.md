...
这是项目故事、模型解释和路径查询的阅读入口。

## 它属于项目哪一步

Stage 0–8：串起为什么做实验、结果说明什么、下一步做什么。
...
| [LAB_FEEDBACK_HANDOFF.md](LAB_FEEDBACK_HANDOFF.md) | 本轮文档/QuickTest/数据规则验收、保护哈希与完整修改清单。 | 手写维护 | 本轮交付记录，后续变更另留痕 |
...
不知道模型是什么看MODEL_CATALOG；不知道为什么做看EXPERIMENT_MAP。
